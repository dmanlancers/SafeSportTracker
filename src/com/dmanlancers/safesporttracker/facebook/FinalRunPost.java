...
public class FinalRunPost extends Activity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String terminar_corrida = getString(R.string.terminar_corrida);
		...
		if (facebookMessage == null && ConversorM.equals("Km") ){ /* Envio da msg para o face */
			Intent postOnFacebookWallIntent = new Intent(this, FinalRunPost.class);
			postOnFacebookWallIntent.putExtra("facebookMessage", "");
			startActivity(postOnFacebookWallIntent);
			facebookMessage = terminar_corrida+":"+time+"\n"+dia+":"+data+"\n"+percurso+":"+"\n"
	...
	public String setFileName(String filename) {
		...
		FinalRunPost.currentFileName = filename;
	...
	public  void setDistance(float distance) {
		// TODO Auto-generated method stub
		dist= distance;	
		FinalRunPost.Dist=dist;
	}
	public  void setMaxSpeed(double Mkph) {
		// TODO Auto-generated method stub
		Speed = Mkph;	
		FinalRunPost.MaxSp = Speed;
	}
	public  void setAvgSpeed(double avgSpeed) {
		// TODO Auto-generated method stub
		Avg = avgSpeed;	
		FinalRunPost.Avgsp = Avg;
	}
	public  void setAltGain(double altitude) {
		// TODO Auto-generated method stub
		Altitude = altitude;	
		FinalRunPost.Alt = Altitude;
	}
