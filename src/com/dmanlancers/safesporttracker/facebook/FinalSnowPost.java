...
public class FinalSnowPost extends Activity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String terminar_snowboard = getString(R.string.terminar_snowboard);
		...
		if (facebookMessage == null && ConversorM.equals("Km") ){ /* Envio da msg para o face */
			Intent postOnFacebookWallIntent = new Intent(this, FinalSnowPost.class);
			postOnFacebookWallIntent.putExtra("facebookMessage", "");
			startActivity(postOnFacebookWallIntent);
			facebookMessage = terminar_snowboard+":"+time+"\n"+dia+":"+data+"\n"+percurso+":"+"\n"
	...
	public String setFileName(String filename) {
		...
		FinalSnowPost.currentFileName = filename;
	...
	public  void setDistance(float distance) {
		// TODO Auto-generated method stub
		dist= distance;	
		FinalSnowPost.Dist=dist;
	}
	public  void setMaxSpeed(double Mkph) {
		// TODO Auto-generated method stub
		Speed = Mkph;	
		FinalSnowPost.MaxSp = Speed;
	}
	public  void setAvgSpeed(double avgSpeed) {
		// TODO Auto-generated method stub
		Avg = avgSpeed;	
		FinalSnowPost.Avgsp = Avg;
	}
	public  void setAltGain(double altitude) {
		// TODO Auto-generated method stub
		Altitude = altitude;	
		FinalSnowPost.Alt = Altitude;
	}
