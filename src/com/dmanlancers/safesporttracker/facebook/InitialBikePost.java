...
public class InitialBikePost extends Activity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String iniciar_ciclismo = getString(R.string.iniciar_ciclismo);
		...
		if (facebookMessage == null){ /* Envio da msg para o face */
			Intent postOnFacebookWallIntent = new Intent(this, InitialBikePost.class);
			postOnFacebookWallIntent.putExtra("facebookMessage", "");
			startActivity(postOnFacebookWallIntent);
			facebookMessage = iniciar_ciclismo+":"+time+"\n"+dia+":"+data+"\n"+acompanhe+":"+"\n"
	...
	public String setFileName(String filename) {
		...
		InitialBikePost.currentFileName = filename;
