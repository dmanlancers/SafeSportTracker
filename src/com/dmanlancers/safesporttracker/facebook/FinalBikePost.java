...
public class FinalBikePost extends Activity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String terminar_ciclismo = getString(R.string.terminar_ciclismo);
		...
		if (facebookMessage == null && ConversorM.equals("Km") ){ /* Envio da msg para o face */
			Intent postOnFacebookWallIntent = new Intent(this, FinalBikePost.class);
			postOnFacebookWallIntent.putExtra("facebookMessage", "");
			startActivity(postOnFacebookWallIntent);
			facebookMessage = terminar_ciclismo+":"+time+"\n"+dia+":"+data+"\n"+percurso+":"+"\n"
	...
	public String setFileName(String filename) {
		...
		FinalBikePost.currentFileName = filename;
	...
	public  void setDistance(float distance) {
		// TODO Auto-generated method stub
		dist= distance;	
		FinalBikePost.Dist=dist;
	}
	public  void setMaxSpeed(double Mkph) {
		// TODO Auto-generated method stub
		Speed = Mkph;	
		FinalBikePost.MaxSp = Speed;
	}
	public  void setAvgSpeed(double avgSpeed) {
		// TODO Auto-generated method stub
		Avg = avgSpeed;	
		FinalBikePost.Avgsp = Avg;
	}
	public  void setAltGain(double altitude) {
		// TODO Auto-generated method stub
		Altitude = altitude;	
		FinalBikePost.Alt = Altitude;
	}
