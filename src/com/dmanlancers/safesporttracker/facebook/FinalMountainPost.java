...
public class FinalMountainPost extends Activity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String terminar_montanhismo = getString(R.string.terminar_montanhismo);
		...
		if (facebookMessage == null && ConversorM.equals("Km") ){ /* Envio da msg para o face */
			Intent postOnFacebookWallIntent = new Intent(this, FinalMountainPost.class);
			postOnFacebookWallIntent.putExtra("facebookMessage", "");
			startActivity(postOnFacebookWallIntent);
			facebookMessage = terminar_montanhismo+":"+time+"\n"+dia+":"+data+"\n"+percurso+":"+"\n"
	...
	public String setFileName(String filename) {
		...
		FinalMountainPost.currentFileName = filename;
	...
	public  void setDistance(float distance) {
		// TODO Auto-generated method stub
		dist= distance;	
		FinalMountainPost.Dist=dist;
	}
	public  void setMaxSpeed(double Mkph) {
		// TODO Auto-generated method stub
		Speed = Mkph;	
		FinalMountainPost.MaxSp = Speed;
	}
	public  void setAvgSpeed(double avgSpeed) {
		// TODO Auto-generated method stub
		Avg = avgSpeed;	
		FinalMountainPost.Avgsp = Avg;
	}
	public  void setAltGain(double altitude) {
		// TODO Auto-generated method stub
		Altitude = altitude;	
		FinalMountainPost.Alt = Altitude;
	}
