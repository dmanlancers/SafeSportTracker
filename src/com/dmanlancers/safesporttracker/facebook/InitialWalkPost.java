...
public class InitialWalkPost extends Activity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String iniciar_caminhada = getString(R.string.iniciar_caminhada);
		...
		if (facebookMessage == null){ /* Envio da msg para o face */
			Intent postOnFacebookWallIntent = new Intent(this, InitialWalkPost.class);
			postOnFacebookWallIntent.putExtra("facebookMessage", "");
			startActivity(postOnFacebookWallIntent);
			facebookMessage = iniciar_caminhada+":"+time+"\n"+dia+":"+data+"\n"+acompanhe+":"+"\n"
	...
	public String setFileName(String filename) {
		...
		InitialWalkPost.currentFileName = filename;
