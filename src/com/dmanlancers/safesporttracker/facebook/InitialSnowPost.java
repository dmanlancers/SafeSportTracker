...
public class InitialSnowPost extends Activity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String iniciar_snowboard = getString(R.string.iniciar_snowboard);
		...
		if (facebookMessage == null){ /* Envio da msg para o face */
			Intent postOnFacebookWallIntent = new Intent(this, InitialSnowPost.class);
			postOnFacebookWallIntent.putExtra("facebookMessage", "");
			startActivity(postOnFacebookWallIntent);
			facebookMessage = iniciar_snowboard+":"+time+"\n"+dia+":"+data+"\n"+acompanhe+":"+"\n"
	...
	public String setFileName(String filename) {
		...
		InitialSnowPost.currentFileName = filename;
