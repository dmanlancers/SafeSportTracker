...
public class InitialMountainPost extends Activity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String iniciar_montanhismo = getString(R.string.iniciar_montanhismo);
		...
		if (facebookMessage == null){ /* Envio da msg para o face */
			Intent postOnFacebookWallIntent = new Intent(this, InitialMountainPost.class);
			postOnFacebookWallIntent.putExtra("facebookMessage", "");
			startActivity(postOnFacebookWallIntent);
			facebookMessage = iniciar_montanhismo+":"+time+"\n"+dia+":"+data+"\n"+acompanhe+":"+"\n"
	...
	public String setFileName(String filename) {
		...
		InitialMountainPost.currentFileName = filename;
